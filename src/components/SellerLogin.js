...
function SellerLogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Perform validation using the API data
    const isValidEmail = apiData.some((data) => data.email === formData.email);
    const isValidPassword = apiData.some((data) => data.password === formData.password);
